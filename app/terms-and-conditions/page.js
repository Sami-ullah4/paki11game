...
const page = () => {
  return (
    <section className="px-4 md:px-28 pt-8 pb-12">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  <p>
                    ...
                    which govern Your access to and use of the Service and form
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <p>
                ...
                governed by that Third-Party Social Media Service&apos;s terms
